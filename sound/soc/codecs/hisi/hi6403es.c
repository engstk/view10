...
static void hi6403es_init_chip(struct snd_soc_codec *codec)
{
	...
	hi64xx_update_bits(codec, HI6403ES_SLIM_DATA_IOCONFIG_REG,
			0x7<<HI6403ES_SLIM_DATA_IO_CURRENT_BIT, priv->cdc_ctrl->slimbusdata_cdc_drv<<HI6403ES_SLIM_DATA_IO_CURRENT_BIT);

	hi64xx_update_bits(codec, HI6403ES_SLIM_CLK_IOCONFIG_REG,
			0x7<<HI6403ES_SLIM_CLK_IO_CURRENT_BIT, priv->cdc_ctrl->slimbusclk_cdc_drv<<HI6403ES_SLIM_CLK_IO_CURRENT_BIT);
