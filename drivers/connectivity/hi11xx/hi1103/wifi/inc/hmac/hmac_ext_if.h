...
typedef struct
{
    oal_uint32            *past_netdev[WLAN_VAP_SUPPORT_MAX_NUM_LIMIT]; //p2p cl和dev共用一个业务vap,netdev的个数不会大于最大业务vap个数3
...
extern   oal_uint32  g_ul_print_wakeup_data;
extern   oal_uint8   g_uc_print_host_wakeup_dev;
...
#endif
#ifdef _PRE_WLAN_WAKEUP_SRC_PARSE
extern  oal_void hmac_print_host_wkup_dev_en(oal_bool_enum_uint8 uc_en);
#endif
