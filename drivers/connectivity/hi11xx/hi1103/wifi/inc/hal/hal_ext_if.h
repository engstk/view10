...
#define HAL_M2S_ANT_RSSI_HIGH_TH              30 /* ant0与ant1相差30dB时切换到SISO */
#define HAL_M2S_ANT_RSSI_LOW_TH               10  /* ant0与ant1相差小于10dB时切换到MIMO */
#define HAL_M2S_ANT_RSSI_HIGH_CNT             1000 /* 维持10帧都超过阈值则切换 */
#define HAL_M2S_ANT_RSSI_LOW_CNT              10

#define HAL_M2S_ANT_RSSI_MGMT_TH              10  /* 管理帧ant0与ant1相差10dB时切换到SISO */


#define HAL_M2S_ANT_SNR_HIGH_TH              40 /* ant0与ant1相差30dB时切换到SISO */
#define HAL_M2S_ANT_SNR_LOW_TH               10 /* ant0与ant1相差小于15dB时切换到MIMO */
#define HAL_M2S_ANT_SNR_HIGH_CNT             1000 /* 维持10帧都超过阈值 */
#define HAL_M2S_ANT_SNR_LOW_CNT              10

#define HAL_M2S_RSSI_TBTT_CNT_TH          50   /* 50个tbtt中断触发一次探测 */
#define HAL_M2S_RSSI_MIMO_TBTT_OPEN_TH    50   /* 50个tbtt中断触发一次探测 */
#define HAL_M2S_RSSI_MIMO_TBTT_CLOSE_TH   10   /* 50个tbtt中断触发一次探测 */
...
typedef enum {
    HAL_DEVICE_IDLE_STATE = 0,              /* idle状态 */
    HAL_DEVICE_WORK_STATE = 1,              /* work状态vap up */
    HAL_DEVICE_SCAN_STATE = 2,              /* 扫描状态 */
...
typedef enum {
    ...
    HAL_M2S_EVENT_ANT_RSSI_MISO_TO_C0_SISO,
    HAL_M2S_EVENT_ANT_RSSI_MISO_TO_C1_SISO,
    HAL_M2S_EVENT_ANT_RSSI_SISO_TO_MISO,
    HAL_M2S_EVENT_ANT_RSSI_MISO_TO_MIMO,

    /* 2.test模块 */
    HAL_M2S_EVENT_TEST_MIMO_TO_SISO_C0 = 5,
    HAL_M2S_EVENT_TEST_MIMO_TO_SISO_C1,
    HAL_M2S_EVENT_TEST_SISO_C0_TO_MIMO,
    HAL_M2S_EVENT_TEST_SISO_C1_TO_MIMO,
    HAL_M2S_EVENT_TEST_SISO_C0_TO_SISO_C1,
    HAL_M2S_EVENT_TEST_SISO_C1_TO_SISO_C0,

    /* 3.BT模块 */
    HAL_M2S_EVENT_BT_MIMO_TO_SISO = 11,
    HAL_M2S_EVENT_BT_SISO_TO_MIMO,

    /* 4.hal device抛来的同步事件 */
    HAL_M2S_EVENT_IDLE_BEGIN = 13,
...
OAL_STATIC OAL_INLINE oal_void hal_set_psd_memory(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 **ppul_addr)
{
    HAL_PUBLIC_HOOK_FUNC(_set_psd_memory)(pst_hal_device, ppul_addr);
}
...
OAL_STATIC OAL_INLINE oal_void hal_set_psd_wifi_work_en(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_reg_value)
{
    HAL_PUBLIC_HOOK_FUNC(_set_psd_wifi_work_en)( pst_hal_device, ul_reg_value);
}
...
OAL_STATIC OAL_INLINE oal_void hal_set_sync_data_path_div_num(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_reg_value)
{
    HAL_PUBLIC_HOOK_FUNC(_set_sync_data_path_div_num)( pst_hal_device, ul_reg_value);
}
...
OAL_STATIC OAL_INLINE oal_void hal_get_psd_data(hal_to_dmac_device_stru *pst_hal_device,wlan_channel_bandwidth_enum_uint8 en_bandwidth)
{
    HAL_PUBLIC_HOOK_FUNC(_get_psd_data)(pst_hal_device, en_bandwidth);
}
...
OAL_STATIC OAL_INLINE oal_void hal_corram_write_func(oal_uint8* puc_cal_data_write, oal_uint16 us_frame_len, oal_uint16 us_remain)
{
    HAL_PUBLIC_HOOK_FUNC(_corram_write_func)( puc_cal_data_write, us_frame_len, us_remain);
}
#endif
...
OAL_STATIC  OAL_INLINE oal_void hal_enable_rx_amsdu_mode(hal_to_dmac_device_stru *pst_hal_device)
{
    HAL_PUBLIC_HOOK_FUNC(_enable_rx_amsdu_mode)( pst_hal_device);
}



OAL_STATIC  OAL_INLINE oal_void hal_disable_rx_amsdu_mode(hal_to_dmac_device_stru *pst_hal_device)
{
    HAL_PUBLIC_HOOK_FUNC(_disable_rx_amsdu_mode)( pst_hal_device);
}
...
OAL_STATIC  OAL_INLINE oal_void hal_init_bfee_h2v_ng_en(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 en_user_bw, oal_uint8 uc_txbf_mode, oal_uint8 uc_bfee_enable)
{
    HAL_PUBLIC_HOOK_FUNC(_init_bfee_h2v_ng_en)( pst_hal_device, en_user_bw, uc_txbf_mode, uc_bfee_enable);
}


OAL_STATIC  OAL_INLINE oal_void hal_set_bfee_grouping_codebook(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_user_index, oal_uint8 uc_min_group, oal_uint8 uc_txbf_mode)
{
    HAL_PUBLIC_HOOK_FUNC(_set_bfee_grouping_codebook)( pst_hal_device, uc_user_index, uc_min_group, uc_txbf_mode);
}

#ifdef _PRE_WLAN_FEATURE_TXBF_HW


OAL_STATIC  OAL_INLINE oal_void hal_set_txbf_vht_buff_addr(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_vap_id, oal_uint32 ul_addr)
{
    HAL_PUBLIC_HOOK_FUNC(_set_txbf_vht_buff_addr)( pst_hal_device, uc_vap_id, ul_addr);
}


OAL_STATIC  OAL_INLINE oal_void hal_set_txbf_vht_buff_len(hal_to_dmac_device_stru *pst_hal_device, oal_uint16 us_buffer_len)
{
    HAL_PUBLIC_HOOK_FUNC(_set_txbf_vht_buff_len)( pst_hal_device, us_buffer_len);
}
#endif
...
OAL_STATIC OAL_INLINE oal_void hal_set_ftm_initiator(hal_to_dmac_device_stru *pst_hal_device, oal_bool_enum_uint8 en_ftm_status)
{
    HAL_PUBLIC_HOOK_FUNC(_set_ftm_initiator)(pst_hal_device, en_ftm_status);
}
