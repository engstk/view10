...
typedef enum
{
    ...
    HAL_BTCOEX_PS_STATUE_BOTH      = 3,   /* both a2dp|数传 and page|inquiry BIT0|BIT1 */
...
typedef enum
{
    ...
    HAL_FCS_SERVICE_TYPE_BTCOEX,           /* btcoex共存业务 */
...
typedef struct
{
    oal_uint8 auc_5g_fcc_txpwr_limit_params[WLAN_5G_SUB_BAND_NUM][HAL_CUS_NUM_5G_BW];
...
typedef struct
{
    ...
    oal_uint16                           us_probe_beacon_rx_cnt;
    oal_uint16                           us_probe_tbtt_cnt;
    oal_uint16                           us_beacon_rx_ratio;
    oal_uint16                           us_best_beacon_rx_ratio ;
...
#define TBTT_OFFSET_PROBE_ACCETP_DIF  (2)
...
typedef struct
{
    ...
    oal_uint32                      aul_2g_abort_selfcts_pow_code[WLAN_2G_SUB_BAND_NUM];
    oal_uint32                      aul_2g_abort_cfend_pow_code[WLAN_2G_SUB_BAND_NUM];
    oal_uint32                      aul_2g_abort_null_data_pow_code[WLAN_2G_SUB_BAND_NUM];
    ...
    oal_uint32                      aul_5g_abort_cfend_pow_code[WLAN_5G_SUB_BAND_NUM];
    oal_uint32                      aul_5g_cfend_pow_code[WLAN_5G_SUB_BAND_NUM];
    oal_uint32                      aul_5g_ndp_pow_code[WLAN_5G_SUB_BAND_NUM];
    oal_uint32                      aul_5g_vht_report_pow_code[WLAN_5G_SUB_BAND_NUM];
    oal_uint32                      aul_5g_abort_null_data_pow_code[WLAN_5G_SUB_BAND_NUM];
    oal_uint8                       _rom[4];
#else
...
typedef struct
{
    ...
    oal_bool_enum_uint8                     en_is_supp_rev3;
...
typedef enum {
    HAL_M2S_SWITCH_MODE_NORMAL = 0,         /* action帧初始方案 */
    HAL_M2S_SWITCH_MODE_OTHER  = 1,         /* 采用另一种action方式 */
    HAL_M2S_SWITCH_MODE_NONE   = 2,         /* 切换不发action帧 */

    HAL_M2S_SWITCH_MODE_BUTT
}hal_m2s_switch_mode;
typedef oal_uint8 hal_m2s_switch_mode_uint8;

/* action帧发送类型枚举 */
typedef enum {
    HAL_M2S_ACTION_TYPR_SMPS      = 0,         /* action采用smps */
    HAL_M2S_ACTION_TYPR_OPMODE    = 1,         /* action采用opmode */
    HAL_M2S_ACTION_TYPR_NONE      = 2,         /* 切换不发action帧 */

    HAL_M2S_ACTION_TYPR_BUTT
}hal_m2s_action_type;
typedef oal_uint8 hal_m2s_action_type_uint8;
#endif
...
typedef struct
{
    ...
    hal_m2s_action_type_uint8  en_action_type;          /* 黑名单用户action帧类型，需要和vap下ori交互处理 */
    oal_uint8  auc_rev[1];
} hal_m2s_mgr_blacklist_stru;

typedef struct
{
    hal_m2s_mgr_blacklist_stru        ast_m2s_blacklist[WLAN_BLACKLIST_MAX];        /* 处于管理用户时，需要调整action方案 */
...
#ifdef _PRE_WLAN_FEATURE_PSD_ANALYSIS
extern oal_void hi1151_set_psd_memory(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 **pul_start_addr);
extern oal_void hi1151_free_psd_mem(hal_to_dmac_device_stru * pst_hal_device);
extern oal_void hi1151_get_single_psd_sample(hal_to_dmac_device_stru *pst_hal_device, oal_uint16 us_index, oal_int8 *pc_psd_val);
extern oal_void hi1151_get_psd_data(hal_to_dmac_device_stru * pst_hal_device,wlan_channel_bandwidth_enum_uint8 en_bandwidth);
extern oal_void hi1151_set_psd_en(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_reg_value);
extern oal_void hi1151_set_up_fft_psd_en(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_reg_value);
extern oal_void hi1151_set_psd_nb_det_en(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_reg_value);
extern oal_void hi1151_set_psd_11b_det_en(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_reg_value);
extern oal_void hi1151_set_psd_ofdm_det_en(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_reg_value);
extern oal_void hi1151_set_psd_wifi_work_en(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_reg_value);
extern oal_void hi1151_set_psd_the_bottom_noise(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_reg_value);
extern oal_void hi1151_set_psd_the_num_nb(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_reg_value);
extern oal_void hi1151_set_psd_the_power_nb(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_reg_value);
extern oal_void hi1151_set_psd_the_rssi_nb(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_reg_value);
extern oal_void hi1151_get_psd_info(hal_to_dmac_device_stru * pst_hal_device);
extern oal_void hi1151_set_fft_sample(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_reg_value);

extern oal_void hi1151_set_sync_data_path_div_num(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_reg_value);
extern oal_void hi1151_set_force_reg_clk_on(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_reg_value);
...
extern oal_void hi1151_init_bfee_h2v_ng_en(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_user_bw, oal_uint8 uc_txbf_mode, oal_uint8 uc_bfee_enable);
...
#ifdef _PRE_WLAN_FEATURE_TXBF_HW
extern oal_void hi1151_set_txbf_vht_buff_addr(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_vap_id, oal_uint32 ul_addr);
extern oal_void hi1151_set_txbf_vht_buff_len(hal_to_dmac_device_stru *pst_hal_device, oal_uint16 us_buffer_len);
#endif
...
extern oal_void hi1102_init_bfee_h2v_ng_en(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_user_bw, oal_uint8 uc_txbf_mode, oal_uint8 uc_bfee_enable);
...
#ifdef _PRE_WLAN_FEATURE_PSD_ANALYSIS
extern oal_void hi1103_set_psd_memory(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 **pul_start_addr);
...
extern oal_void hi1103_set_psd_wifi_work_en(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_reg_value);
...
extern oal_void hi1103_get_psd_data(hal_to_dmac_device_stru * pst_hal_device,wlan_channel_bandwidth_enum_uint8 en_bandwidth);
extern oal_void hi1103_set_sync_data_path_div_num(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_reg_value);
...
#ifdef _PRE_WLAN_ONLINE_DPD
extern oal_void hi1103_corram_write_func(oal_uint8* puc_cali_data, oal_uint16 us_frame_len, oal_uint16 us_remain);
...
extern oal_void  hi1103_enable_rx_amsdu_mode(hal_to_dmac_device_stru *pst_hal_device);
extern oal_void  hi1103_disable_rx_amsdu_mode(hal_to_dmac_device_stru *pst_hal_device);
...
#ifdef _PRE_WLAN_FEATURE_TXBF_HW
extern oal_void hi1103_set_txbf_vht_buff_addr(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_vap_id, oal_uint32 ul_addr);
extern oal_void hi1103_set_txbf_vht_buff_len(hal_to_dmac_device_stru *pst_hal_device, oal_uint16 us_buffer_len);
#endif
extern oal_void hi1103_init_bfee_h2v_ng_en(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_user_bw, oal_uint8 uc_txbf_mode, oal_uint8 uc_bfee_enable);
...
extern oal_void hi1103_set_ftm_initiator(hal_to_dmac_device_stru *pst_hal_device, oal_bool_enum_uint8 en_ftm_status);
