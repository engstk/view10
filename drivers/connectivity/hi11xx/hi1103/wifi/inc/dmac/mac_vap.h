...
#define CUS_DY_CALI_PARAMS_NUM              9    /* 动态校准参数个数,2.4g 3个(ofdm 20/40 11b cw),5g 5个band */
...
typedef enum
{
    MAC_VAP_M2S_TYPE_DBDC_START,
    MAC_VAP_M2S_TYPE_DBDC_STOP,
    MAC_VAP_M2S_TYPE_VAP_SWTICH,    //单vap迁移
    MAC_VAP_M2S_TYPE_BT_START,
    MAC_VAP_M2S_TYPE_BT_STOP,
    MAC_VAP_M2S_TYPE_ANT,
    MAC_VAP_M2S_TYPE_ANT_DETECT,
    MAC_VAP_M2S_TYPE_TEST,

    MAC_VAP_M2S_TYPE_BUTT
}mac_vap_m2s_type_enum;
typedef oal_uint8 mac_vap_m2s_type_enum_uint8;
...
extern oal_uint8 g_uc_host_large_amsdu_enable;
#endif
...
#if defined(_PRE_WLAN_FEATURE_11V) || (defined(_PRE_WLAN_FEATURE_FTM))
