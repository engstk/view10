...
struct mac_frame_he_mac_cap
{
    ...
    oal_uint16          bit_min_fragment_size                                  : 2,              /* 最小分片的长度*/
                        ...
                        bit_multi_tid_aggregation_support                      : 3,              /* 多tid聚合支持*/
                        bit_he_link_adaptation                                 : 2,              /*使用邋HE 变体的HT Control field 调整*/
                        ...
                        bit_ack_enabled_mtid_aggregation_support               : 1;/*是否支持 M-TID A-MPDU*/

    oal_uint16          bit_group_addressed_msta_ba_dl_mu_support              : 1,
                    ...
                    bit_rx_control_frame_to_multibss                           : 1,
                    bit_bsrp_ampdu_addregation                                 : 1,
                    bit_qtp_support                                            : 1,
                    bit_bqr_support                                            : 1,
                    bit_sr_responder                                           : 1,
                    bit_reserved                                               : 4;
...
struct mac_frame_he_phy_cap
{
    ...
    oal_uint16          bit_punctured_preamble_rx                              : 4, /**/
                        bit_device_class                                       : 1,              /**/
    ...
    oal_uint8     bit_srp_based_sr_support                                     : 1,
                        bit_power_boost_factor_support                         : 1,
                        bit_4x_he_ltf_8us_gi                                   : 1,
                        bit_max_nc                                             : 3,
...
struct mac_frame_he_tx_rx_mcs_nss
{
    oal_uint16          bit_highest_nss_supported_m1                           : 3, /**/
                        bit_highest_mcs_supported                              : 3,              /**/
                        bit_tx_bw_bitmap                                       : 5,/* */
                        bit_rx_bw_bitmap                                       : 5;/**/
}__OAL_DECLARE_PACKED;
typedef struct mac_frame_he_tx_rx_mcs_nss mac_frame_he_tx_rx_mcs_nss_stru;
...
struct mac_frame_he_operation_param
{
    oal_uint32          bit_bss_color                                          : 6, /**/
                        ...
                        bit_twt_required                                       : 1,/* */
                        bit_he_duration_rts_threshild                          : 10,/**/
...
struct mac_frame_he_basic_mcs_nss
{
    oal_uint32          bit_max_he_mcs_1ss                                     : 3, /**/
                        bit_max_he_mcs_2ss                                     : 3, /**/
                        bit_max_he_mcs_3ss                                     : 3, /**/
                        bit_max_he_mcs_4ss                                     : 3, /**/
                        bit_max_he_mcs_5ss                                     : 3, /**/
                        bit_max_he_mcs_6ss                                     : 3, /**/
                        bit_max_he_mcs_7ss                                     : 3, /**/
                        bit_max_he_mcs_8ss                                     : 3; /**/
}__OAL_DECLARE_PACKED;
typedef struct mac_frame_he_basic_mcs_nss mac_frame_he_basic_mcs_nss_stru;
...
typedef struct
{
    ...
    mac_frame_he_tx_rx_mcs_nss_stru    st_he_tx_rx_mcs_nss;
    mac_frame_he_mcs_nss_stru          st_tx_he_mcs[5];
    mac_frame_he_mcs_nss_stru          st_rx_he_mcs[5];
...
typedef struct
{
    ...
    oal_uint8           bit_q_ack                                              : 1;
    oal_uint8           bit_queue_request                                      : 1;
    oal_uint8           bit_txop_request                                       : 1;
    oal_uint8           bit_more_data_ack                                      : 1;
