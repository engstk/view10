...
/* user replace operation enum */
typedef enum
{
    DMAC_ALG_USER_OPER_TYPE_REPLACE   = 0,
    DMAC_ALG_USER_OPER_TYPE_REPLACED  = 1,

    DMAC_ALG_USER_OPER_TYPE_INVALID
}dmac_alg_user_oper_type_enum;
typedef oal_uint8 dmac_alg_user_oper_type_enum_uint8;
#endif
...
typedef enum
{
    DMAC_ALG_DBDC_START,
    DMAC_ALG_DBDC_STOP,
    DMAC_ALG_DBDC_UP_VAP_SWITCH,

    DMAC_ALG_DBDC_STATE_BUTT
}dmac_alg_dbdc_switch_enum;
typedef oal_uint8 dmac_alg_dbdc_switch_enum_uint8;
...
typedef oal_uint32 (*p_alg_cfg_netbuff_usage_info_notify_func)(mac_cfg_meminfo_stru *pst_meminfo_param);
#ifdef _PRE_WLAN_FEATURE_BTCOEX
typedef oal_void (*p_alg_cfg_btcoex_state_notify_func)(hal_to_dmac_device_stru *pst_hal_device, dmac_alg_bt_state_type_uint8 en_type);
#endif
#endif /* _PRE_MULTI_CORE_MODE_OFFLOAD_DMAC == _PRE_MULTI_CORE_MODE */

#ifdef _PRE_WLAN_FEATURE_SMARTANT
typedef oal_void (*p_alg_cfg_dual_antenna_state_notify_func)(hal_to_dmac_device_stru *pst_hal_device, oal_uint32 ul_status);
#endif


#ifdef _PRE_WLAN_FEATURE_USER_RESP_POWER
typedef oal_uint32 (*p_alg_cfg_rx_mgmt_power_notify_func)(mac_vap_stru *pst_vap, oal_int c_rssi);
#endif
...
typedef oal_uint32 (*p_alg_cfg_intf_det_mode_notify_func)(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_old_intf_mode, oal_uint8 uc_cur_intf_mode);
#ifdef _PRE_WLAN_FEATURE_NEGTIVE_DET
typedef oal_void   (*p_alg_intf_det_pk_mode_notify_func)(dmac_vap_stru *pst_dmac_vap, oal_bool_enum_uint8    en_is_pk_mode);
#endif
#ifdef _PRE_WLAN_FEATURE_PSD_ANALYSIS
typedef oal_uint32 (*p_alg_intf_det_psd_notify_func)(hal_to_dmac_device_stru *pst_hal_device);
#endif
#endif
...
typedef oal_uint32 (*p_alg_txmgmt_notify_func)(mac_user_stru *pst_user, hal_tx_txop_alg_stru *pst_txop_param);
...
#endif
/* 调度相关回调 */
typedef oal_uint32 (*p_alg_tx_schedule_func)(hal_to_dmac_device_stru *pst_device, oal_uint8 uc_ac_num, mac_tid_schedule_output_stru *pst_sch_output);
#ifdef _PRE_WLAN_FEATURE_EDCA_MULTI_USER_MULTI_AC
typedef oal_uint32 (*p_alg_tx_schedule_stat_event_notify_func)(oal_uint8 uc_vap_id, oal_uint8 (*ppuc_traffic_num)[ALG_TXRX_DATA_MAXNUM]);
#endif
...
typedef oal_uint32 (*p_alg_mu_flowctl_netbuff_free_notify_func)(mac_user_stru *pst_user, oal_uint16 us_free_cnt);
...
/*处理接收控制帧回调*/
typedef oal_uint32  (*p_alg_rx_cntl_notify_func)(mac_vap_stru *pst_vap, mac_user_stru *pst_user, oal_netbuf_stru *pst_buf);

typedef oal_uint32 (*p_alg_config_func)(mac_vap_stru *pst_mac_vap, oal_uint8 uc_argc, oal_int8 *pac_argv[]);

/*dbac状态通知回调*/
#ifdef _PRE_WLAN_FEATURE_DBAC
typedef oal_uint32 (*p_alg_dbac_status_notify_func)(mac_device_stru *pst_device);
#endif
...
#endif
typedef oal_uint32 (*p_alg_get_user_rate_idx_for_tx_power_func)(mac_user_stru *pst_mac_user, oal_bool_enum_uint8 *puc_ar_enable, oal_uint8 *puc_rate_to_pow_code_idx);
typedef oal_uint32 (*p_alg_get_vap_rate_idx_for_tx_power_func)(mac_user_stru *pst_mac_user,
                                                      hal_tx_dscr_ctrl_one_param *pst_tx_dscr_param,
                                                      oal_uint8 *puc_rate_index,
                                                      oal_uint8 *puc_rate_to_pow_code_idx);
typedef oal_uint32 (*p_alg_get_rate_by_table_func)(mac_user_stru *pst_mac_user, dmac_rx_ctl_stru *pst_cb_ctrl, oal_uint32 *pul_rate_kbps);
...
typedef oal_uint32 (*p_alg_dbac_pause_func)(hal_to_dmac_device_stru *pst_hal_device);
typedef oal_uint32 (*p_alg_dbac_resume_func)(hal_to_dmac_device_stru *pst_hal_device, oal_bool_enum_uint8 en_need_resume_channel);
typedef oal_bool_enum_uint8 (*p_alg_dbac_is_pause)(hal_to_dmac_device_stru *pst_hal_device);
typedef oal_uint32 (*p_alg_anti_intf_switch_func)(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_alg_enable);
...
typedef oal_uint32 (*p_alg_double_ant_switch_notify_func)(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_param);
#endif
#ifdef _PRE_WLAN_FEATURE_TPC
typedef oal_uint32 (*p_alg_get_user_target_tx_power_func)(mac_user_stru *pst_mac_user, hal_tx_dscr_ctrl_one_param *pst_tx_dscr_param, oal_int16 *ps_tx_pow);
typedef oal_uint32 (*p_alg_change_target_upc_gain_func)(mac_vap_stru *pst_mac_vap);
#endif

typedef oal_uint32 (*p_alg_user_active_change_notify_func)(dmac_user_stru *pst_dmac_user);
#ifdef _PRE_WLAN_FEATURE_USER_EXTEND
typedef oal_uint32 (*p_alg_user_replace_notify_func)(dmac_user_stru *pst_dmac_user, dmac_alg_user_oper_type_enum_uint8 en_oper_type);
#endif

typedef oal_uint32 (*p_alg_get_rate_kbps_func)(hal_to_dmac_device_stru *pst_hal_device, hal_statistic_stru *pst_per_rate, oal_uint32 *pul_rate_kbps);

#ifdef _PRE_WLAN_FEATURE_DBDC
typedef oal_bool_enum_uint8 (*p_alg_dbdc_alg_shift_func)(mac_vap_stru *pst_shift_vap, dmac_alg_dbdc_switch_enum_uint8 en_dbdc_state);
#endif
...
typedef enum
{
    ...
    DMAC_ALG_ID_INTF_DET     = 0x00001000,
    DMAC_ALG_ID_RX_DSCR_CTL  = 0x00002000,
#ifdef _PRE_WLAN_CHIP_TEST_ALG
...
typedef enum
{
    DMAC_ALG_CHIP_STRU_ID_START,
#ifdef _PRE_WLAN_FEATURE_MU_TRAFFIC_CTL
    DMAC_ALG_CHIP_STRU_ID_TRAFFIC_CTL, //110x多用户拥塞控制
    DMAC_ALG_CHIP_STRU_ID_RX_DSCR_CTL, //110x接收端多device描述符分配
#endif

    DMAC_ALG_CHIP_STRU_ID_BUTT
}dmac_alg_chip_stru_id_enum;
typedef oal_uint8 dmac_alg_chip_stru_id_enum_uint8;
...
typedef enum
{
    ...
    DMAC_ALG_USER_STRU_ID_INTF_DET,
    DMAC_ALG_USER_STRU_ID_TRAFFIC_CTL,
...
typedef enum
{
    DMAC_ALG_VAP_UP_START  = 0,
    DMAC_ALG_VAP_UP_DBAC   = DMAC_ALG_VAP_UP_START,
    DMAC_ALG_VAP_UP_TPC,
...
typedef enum
{
    DMAC_ALG_VAP_DOWN_START  = 0,
    DMAC_ALG_VAP_DOWN_DBAC   = DMAC_ALG_VAP_DOWN_START,
...
typedef enum
{
    DMAC_ALG_DBAC_STATUS_NOTIFY_START = 0,

#ifdef _PRE_WLAN_FEATURE_TXBF
    DMAC_ALG_DBAC_STATUS_NOTIFY_TXBF = DMAC_ALG_DBAC_STATUS_NOTIFY_START,
#endif
    DMAC_ALG_DBAC_STATUS_NOTIFY_BUTT
}dmac_alg_dbac_status_notify_enum;
typedef oal_uint8 dmac_alg_dbac_status_notify_enum_uint8;
...
typedef enum
{
    ...
    DMAC_ALG_TX_MGMT_TXBF  = DMAC_ALG_TX_MGMT_START,
...
#endif
#ifdef _PRE_WLAN_FEATURE_MU_TRAFFIC_CTL
    DMAC_ALG_TX_COMPLETE_TRAFFIC_CTL,
#endif
...
typedef enum
{
    ...
    DMAC_ALG_ADD_USER_NOTIFY_HWBW_2040,
#endif
...
//#ifdef _PRE_WLAN_FEATURE_MWO_DET
    DMAC_ALG_ADD_USER_NOTIFY_MWO_DET,
//#endif
    ...
    DMAC_ALG_ADD_USER_NOTIFY_INTF_DET,
  //  DMAC_ALG_ADD_USER_NOTIFY_CCA_OPT,
#ifdef _PRE_WLAN_FEATURE_MU_TRAFFIC_CTL
    DMAC_ALG_ADD_USER_NOTIFY_TRAFFIC_CTL,
#endif
#ifdef _PRE_WLAN_MAC_ADDR_EDCA_FIX
    DMAC_ALG_ADD_USER_NOTIFY_FIX_EDCA,
#endif
...
typedef enum
{
...
#ifdef _PRE_WLAN_FEATURE_HWBW_20_40
    DMAC_ALG_DEL_USER_NOTIFY_HWBW_2040,
#endif
    ...
    DMAC_ALG_DEL_USER_NOTIFY_INTF_DET,
    DMAC_ALG_DEL_USER_NOTIFY_CCA_OPT,
#ifdef _PRE_WLAN_FEATURE_MU_TRAFFIC_CTL
    DMAC_ALG_DEL_USER_NOTIFY_TRAFFIC_CTL,
#endif
#ifdef _PRE_WLAN_MAC_ADDR_EDCA_FIX
    DMAC_ALG_DEL_USER_NOTIFY_FIX_EDCA,
#endif
...
typedef enum
{
    DMAC_ALG_CFG_NETBUFF_INFO_NOTIFY_USAGE,

    DMAC_ALG_CFG_NETBUFF_INFO_NOTIFY_BUTT,
}dmac_alg_cfg_netbuff_info_notify_enum;
typedef oal_uint8 dmac_alg_cfg_netbuff_info_notify_enum_uint8;
...
typedef enum
{
    DMAC_ALG_CFG_BTCOEX_STATE_NOTIFY_AUTORATE,
    DMAC_ALG_CFG_BTCOEX_STATE_NOTIFY_TPC,
...
/*干扰识别模块识别邻频叠频干扰通知其他算法*/
/*注意当干扰状态没改变不需要处理时，放在DMAC_MODULE之前*/
typedef enum
{
    DMAC_ALG_CFG_INTF_DET_MODE_NOTIFY_TPC,
    DMAC_ALG_CFG_INTF_DET_MODE_NOTIFY_DMAC_MODULE,   //干扰状态不改变无须通知时，请放到DMAC模块前

    DMAC_ALG_CFG_INTF_DET_MODE_NOTIFY_CCA,

    DMAC_ALG_CFG_INTF_DET_MODE_NOTIFY_BUTT,
}dmac_alg_cfg_intf_det_mode_notify_enum;
typedef oal_uint8 dmac_alg_cfg_intf_det_mode_notify_enum_uint8;
...
typedef enum
{
    ...
    DMAC_ALG_CFG_USER_SPATIAL_STREAM_NOTIFY_TXBF,
...
typedef enum
{
    DMAC_ALG_CFG_RX_MGMT_POWER_NOTIFY_TPC,

    DMAC_ALG_CFG_RX_MGMT_POWER_NOTIFY_BUTT,
}dmac_alg_cfg_rx_mgmt_power_notify_enum;
typedef oal_uint8 dmac_alg_cfg_rx_mgmt_power_notify_enum_uint8;
#endif
...
typedef enum
{
    DMAC_ALG_RX_CNTL_AUTORATE,

    DMAC_ALG_RX_CNTL_NOTIFY_BUTT

}dmac_alg_rx_cntl_notify_enum;
typedef oal_uint8 dmac_alg_rx_cntl_notify_enum_uint8;
...
typedef enum
{
    DMAC_ALG_USER_ACTIVE_CHANGE_NOTIFY_TXBF,

    DMAC_ALG_USER_ACTIVE_CHANGE_NOTIFY_BUTT,
}dmac_alg_user_active_change_notify_enum;
typedef oal_uint8 dmac_alg_user_active_change_notify_enum_uint8;

#ifdef _PRE_WLAN_FEATURE_USER_EXTEND
/* 用户替换通知算法子特性枚举 */
typedef enum
{
    DMAC_ALG_USER_REPLACE_NOTIFY_TXBF,

    DMAC_ALG_USER_REPLACE_NOTIFY_BUTT,
}dmac_alg_user_replace_notify_enum;
typedef oal_uint8 dmac_alg_user_replace_notify_enum_uint8;
#endif
...
typedef struct
{
    oal_void       *p_alg_info[DMAC_ALG_CHIP_STRU_ID_BUTT];
}dmac_alg_chip_stru;
...
typedef struct
{
    hal_alg_user_distance_enum_uint8  en_old_distance;    /* 变化前的距离状态信息 */
    hal_alg_user_distance_enum_uint8  en_new_distance;    /* 变化后的距离状态信息 */
...
#if (_PRE_MULTI_CORE_MODE_OFFLOAD_DMAC == _PRE_MULTI_CORE_MODE)
extern oal_uint32  dmac_alg_register_nerbuff_usage_notify_func(dmac_alg_cfg_netbuff_info_notify_enum_uint8  en_notify_sub_type,
                                                            p_alg_cfg_netbuff_usage_info_notify_func p_func);
extern oal_uint32  dmac_alg_unregister_nerbuff_usage_notify_func(dmac_alg_cfg_netbuff_info_notify_enum_uint8  en_notify_sub_type);
...
extern oal_uint32  dmac_alg_register_mu_flowctl_netbuff_free_notify_func(p_alg_mu_flowctl_netbuff_free_notify_func p_func);
...
extern oal_uint32  dmac_alg_register_rx_cntl_notify_func(dmac_alg_rx_cntl_notify_enum_uint8 en_notify_sub_type, p_alg_rx_cntl_notify_func p_func);
...
extern oal_uint32  dmac_alg_unregister_flowctl_netbuff_free_notify_func(oal_void);
...
#ifdef _PRE_WLAN_FEATURE_INTF_DET
extern oal_uint32  dmac_alg_register_cfg_intf_det_mode_notify_func(dmac_alg_cfg_intf_det_mode_notify_enum_uint8 en_notify_sub_type,
                                                               p_alg_cfg_intf_det_mode_notify_func        p_func);
extern oal_uint32  dmac_alg_unregister_cfg_intf_det_mode_notify_func(dmac_alg_cfg_intf_det_mode_notify_enum_uint8 en_notify_sub_type);
extern oal_uint32  dmac_alg_cfg_intf_det_mode_notify(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_intf_mode_old, oal_uint8 uc_intf_mode_new);
#ifdef _PRE_WLAN_FEATURE_NEGTIVE_DET
extern oal_uint32  dmac_alg_register_intf_det_pk_mode_notify_func(p_alg_intf_det_pk_mode_notify_func p_func);
extern oal_uint32  dmac_alg_unregister_intf_det_pk_mode_notify_func(oal_void);
extern oal_uint32  dmac_alg_cfg_intf_det_pk_mode_notify(dmac_vap_stru *pst_dmac_vap, oal_bool_enum_uint8 en_is_pk_mode);
#endif

#ifdef _PRE_WLAN_FEATURE_PSD_ANALYSIS
extern oal_uint32  dmac_alg_register_intf_det_psd_notify_func(p_alg_intf_det_psd_notify_func p_func);
extern oal_uint32  dmac_alg_unregister_intf_det_psd_notify_func(oal_void);
extern oal_uint32  dmac_alg_cfg_intf_det_psd_notify(hal_to_dmac_device_stru *pst_hal_device);
#endif
#endif
...
extern oal_uint32  dmac_alg_register_probe_req_rx_notify_func(dmac_alg_probe_req_rx_notify_enum_uint8 en_notify_sub_type, p_alg_probe_req_rx_notify_func p_func);
...
extern oal_uint32  dmac_alg_unregister_rx_cntl_notify_func(dmac_alg_rx_cntl_notify_enum_uint8 en_notify_sub_type);
#ifdef _PRE_WLAN_FEATURE_USER_RESP_POWER
extern oal_uint32  dmac_alg_unregister_cfg_rx_mgmt_power_notify_func(dmac_alg_cfg_rx_mgmt_power_notify_enum_uint8 en_notify_sub_type);
#endif

/***************** 注册数据结构接口 ******************** */
extern oal_uint32  dmac_alg_register_chip_priv_stru(mac_chip_stru                 *pst_mac_chip,
                                                  dmac_alg_chip_stru_id_enum_uint8    en_chip_stru_type,
                                                  oal_void                           *p_chip_stru);
extern oal_uint32  dmac_alg_unregister_chip_priv_stru(mac_chip_stru                 *pst_mac_chip,
                                                  dmac_alg_chip_stru_id_enum_uint8    en_chip_stru_type);

extern oal_uint32  dmac_alg_register_device_priv_stru(hal_to_dmac_device_stru    *pst_hal_dev,
...
/***************** 注销数据结构接口 ****************** */
extern oal_uint32  dmac_alg_unregister_device_priv_stru(hal_to_dmac_device_stru  *pst_hal_dev,
                                                            hal_alg_device_stru_id_enum_uint8    en_dev_stru_type);
...
/***************** 获取数据结构接口 ****************** */
extern oal_uint32  dmac_alg_get_chip_priv_stru(mac_chip_stru *pst_chip_dev,
                                                        dmac_alg_chip_stru_id_enum_uint8 en_chip_stru_type,
                                                        oal_void **pp_chip_stru);
extern oal_uint32  dmac_alg_get_device_priv_stru(hal_to_dmac_device_stru  *pst_hal_dev,
                                             hal_alg_device_stru_id_enum_uint8    en_dev_stru_type,
                                             oal_void                        **pp_dev_stru);
extern oal_uint32  dmac_alg_get_vap_priv_stru(mac_vap_stru                 *pst_vap,
                                         dmac_alg_vap_stru_id_enum_uint8    en_vap_stru_type,
                                         oal_void                     **pp_vap_stru);
extern oal_uint32  dmac_alg_get_user_priv_stru(OAL_CONST mac_user_stru * OAL_CONST pst_user,
                                          dmac_alg_user_stru_id_enum_uint8   en_user_stru_type,
                                          oal_void                     **pp_user_stru);
extern oal_uint32  dmac_alg_get_tid_priv_stru(OAL_CONST mac_user_stru * OAL_CONST pst_user,
                                       oal_uint8                    uc_tid_no,
                                       dmac_alg_tid_stru_id_enum_uint8   en_tid_stru_type,
...
extern wlan_bw_cap_enum_uint8 dmac_alg_get_device_bw_mode(hal_to_dmac_device_stru *pst_hal_device);
...
extern oal_uint32  dmac_user_set_txchain_mask(mac_user_stru *pst_user,
                                                         ...
                                                         oal_uint8 puc_chainmask);
#endif
extern oal_bool_enum_uint8  dmac_user_get_vip_flag(OAL_CONST mac_user_stru * OAL_CONST pst_user);
...
extern oal_uint32  dmac_mgmt_switch_channel(hal_to_dmac_device_stru *pst_hal_device, mac_channel_stru *pst_channel, oal_bool_enum en_clear_fifo);
...
extern oal_uint32  dmac_alg_register_get_user_rate_idx_for_tx_power_notify(p_alg_get_user_rate_idx_for_tx_power_func p_func);
extern oal_uint32  dmac_alg_unregister_get_user_rate_idx_for_tx_power_notify(oal_void);
extern oal_uint32  dmac_alg_register_get_vap_rate_idx_for_tx_power_notify(p_alg_get_vap_rate_idx_for_tx_power_func p_func);
extern oal_uint32  dmac_alg_unregister_get_vap_rate_idx_for_tx_power_notify(oal_void);

extern oal_uint32  dmac_alg_get_user_rate_idx_for_tx_power(mac_user_stru *pst_mac_user, oal_bool_enum_uint8 *puc_ar_enable,
                                    oal_uint8 *puc_rate_to_pow_code_idx);

extern oal_uint32  dmac_alg_get_vap_rate_idx_for_tx_power(mac_user_stru *pst_mac_user,
                                                      hal_tx_dscr_ctrl_one_param *pst_tx_dscr_param,
                                                      oal_uint8 *puc_rate_index,
                                                      oal_uint8 *puc_rate_to_pow_code_idx);
...
typedef oal_uint32  (*p_alg_edca_stat_event_notify_func)(oal_uint8 uc_vap_id, oal_uint8 (*ppuc_traffic_num)[ALG_TXRX_DATA_BUTT]);
...
extern oal_uint32  dmac_alg_dbac_pause(hal_to_dmac_device_stru *pst_hal_device);
extern oal_uint32  dmac_alg_dbac_resume(hal_to_dmac_device_stru *pst_hal_device, oal_bool_enum_uint8 en_need_resume_channel);
extern oal_bool_enum_uint8  dmac_alg_dbac_is_pause(hal_to_dmac_device_stru *pst_hal_device);
#endif
#ifdef _PRE_WLAN_FEATURE_DBDC
extern oal_uint32  dmac_alg_register_dbdc_shift_alg(p_alg_dbdc_alg_shift_func   p_func);
extern oal_bool_enum_uint8  dmac_alg_dbdc_shift_alg(mac_vap_stru *pst_shift_vap, dmac_alg_dbdc_switch_enum_uint8 en_dbdc_state);
#endif
...
extern oal_uint32 dmac_alg_co_intf_notify_hook(hal_to_dmac_device_stru *pst_hal_device, oal_bool_enum_uint8 en_intf_state_cur, oal_bool_enum_uint8 en_intf_state_old);
extern oal_uint32 dmac_alg_intf_det_notify_hook(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_intf_mode_old, oal_uint8 uc_intf_mode_new);
...
extern oal_uint32  dmac_alg_user_active_change_notify(dmac_user_stru *pst_dmac_user);
extern oal_uint32  dmac_alg_register_user_active_change_notify_func(
                dmac_alg_user_active_change_notify_enum_uint8   en_notify_sub_type,
                p_alg_user_active_change_notify_func            p_func);
extern oal_uint32  dmac_alg_unregister_user_active_change_notify_func(dmac_alg_user_active_change_notify_enum_uint8 en_notify_sub_type);
#ifdef _PRE_WLAN_FEATURE_USER_EXTEND
extern oal_uint32  dmac_alg_register_user_replace_notify_func(
                dmac_alg_user_replace_notify_enum_uint8         en_notify_sub_type,
                p_alg_user_replace_notify_func                  p_func);
extern oal_uint32  dmac_alg_unregister_user_replace_notify_func(dmac_alg_user_replace_notify_enum_uint8 en_notify_sub_type);
extern oal_uint32  dmac_alg_user_replace_notify(dmac_user_stru *pst_dmac_user, dmac_alg_user_oper_type_enum_uint8 en_oper_type);
#endif
extern oal_uint32  dmac_alg_register_get_rate_kbps_func(p_alg_get_rate_kbps_func  p_func);
extern oal_uint32  dmac_alg_unregister_get_rate_kbps_func(oal_void);
extern oal_uint32  dmac_alg_get_rate_kbps(hal_to_dmac_device_stru *pst_device, hal_statistic_stru *pst_per_rate, oal_uint32 *pul_rate_kbps);
