...
#define  DMAC_DFT_AP_BEACON_MISS_MAX_NUM(_idx, _val, _pul_val)  do {   \
         *_pul_val = ((oal_uint8)((oal_uint32)0xFF << ((_idx) << 3)) & (_val)) >> ((_idx) << 3);  \
         }while(0)
...
extern oal_void  dmac_dft_report_linkloss_info(dmac_vap_stru *pst_dmac_sta, mac_device_stru *pst_mac_dev);
#endif

extern oal_uint32  dmac_dft_set_phy_stat_node(hal_to_dmac_device_stru     *pst_hal_device,
...
#endif
extern oal_void  dmac_dft_calcu_antenna_power(hal_to_dmac_device_stru *pst_hal_device);
...
extern oal_void dmac_dft_print_mac_phy_rf(hal_to_dmac_device_stru *pst_hal_device);
