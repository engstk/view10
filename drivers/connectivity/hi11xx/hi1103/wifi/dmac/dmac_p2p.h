...
/*****************************************************************************
  4 全局变量声明
*****************************************************************************/
typedef oal_uint16  (*encap_p2p_presence_rsp)(dmac_vap_stru *pst_dmac_vap, oal_netbuf_stru *pst_netbuf, oal_uint8 *puc_data);
typedef oal_void  (*set_p2p_noa)(oal_void *pst_vap, oal_uint8 *puc_buffer, oal_uint8 *puc_ie_len);



typedef struct
{
    encap_p2p_presence_rsp encap_p2p_presence_rsp_cb;
    set_p2p_noa            set_p2p_noa_cb;


}dmac_p2p_cb;
extern dmac_p2p_cb g_st_dmac_p2p_rom_cb;
/*****************************************************************************
  5 消息头定义
*****************************************************************************/
...
extern oal_bool_enum_uint8 dmac_is_p2p_go_neg_req_frame(OAL_CONST oal_uint8* puc_data);
extern oal_bool_enum_uint8 dmac_is_p2p_pd_disc_req_frame(OAL_CONST oal_uint8 *puc_data);
extern oal_uint32  dmac_p2p_listen_filter_vap(dmac_vap_stru *pst_dmac_vap);
extern oal_uint32  dmac_p2p_listen_filter_frame(dmac_vap_stru *pst_dmac_vap, oal_uint8 *puc_frame_body, oal_uint16 us_frame_len);
#ifdef _PRE_WLAN_FEATURE_STA_PM
extern oal_void dmac_p2p_resume_send_null_to_ap(dmac_vap_stru *pst_dmac_vap,mac_sta_pm_handler_stru *pst_mac_sta_pm_handle);
#endif
