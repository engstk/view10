...
typedef struct
{
    oal_void      (* p_func)(mac_device_stru *pst_mac_device, hal_to_dmac_device_stru  *pst_hal_device, oal_uint32 ul_para);
    oal_uint32    ul_param;
                ...
                dmac_rx_ctl_stru           *pst_cb_ctrl)
{
    ...
    if (OAL_UNLIKELY(MAC_GET_RX_CB_MAC_HEADER_LEN(&(pst_cb_ctrl->st_rx_info)) > pst_cb_ctrl->st_rx_info.us_frame_len))
    {
        ...
        oam_report_dscr(BROADCAST_MACADDR, (oal_uint8 *)pul_rx_dscr, (oal_uint16)ul_rx_dscr_len, OAM_OTA_RX_DSCR_TYPE);
    }
...
OAL_STATIC OAL_INLINE oal_void dmac_rx_rssi_rate_stat(dmac_user_stru *pst_dmac_user, dmac_rx_ctl_stru *pst_cb_ctrl, mac_device_stru *pst_mac_device)
{
    ...
    /* 获取速率大小 */
    dmac_alg_get_rate_by_table(&pst_dmac_user->st_user_base_info, pst_cb_ctrl, &ul_rate_kbps);
                ...
                oal_netbuf_stru                *pst_netbuf)
{
   ...
   // pst_frame_hdr = (mac_ieee80211_frame_stru *)(pst_cb_ctrl->st_rx_info.pul_mac_hdr_start_addr);
    ...
    dmac_rx_rssi_rate_stat(pst_dmac_user, pst_cb_ctrl, pst_mac_device);

#ifdef _PRE_WLAN_PHY_BUGFIX_IMPROVE_CE_TH
    dmac_rx_compatibility_identify(pst_dmac_user, pst_dmac_vap->pst_hal_device->ul_rx_rate);
#endif
...
OAL_STATIC OAL_INLINE oal_uint32 dmac_rx_record_tid(mac_vap_stru  *pst_vap, mac_ieee80211_frame_stru  *pst_frame)
{
    ...
    if(OAL_UNLIKELY(OAL_PTR_NULL == pst_frame))
    {
        return OAL_ERR_CODE_PTR_NULL;
    }
...
extern oal_uint32  dmac_rx_get_vap(hal_to_dmac_device_stru *pst_hal_device, oal_uint8 uc_hal_vap_id, oal_uint8 uc_rx_queue_id, mac_vap_stru **pst_vap);
extern oal_uint32  dmac_rx_send_event(
                dmac_vap_stru                           *pst_dmac_vap,
                dmac_wlan_crx_event_sub_type_enum_uint8  en_event,
                oal_uint8                               *puc_param,
                oal_uint32                               ul_len);
extern oal_bool_enum_uint8 dmac_check_arp_req_owner(oal_netbuf_stru *pst_netbuf, oal_uint8 uc_vap_id, oal_uint8 uc_data_type);

#ifdef _PRE_WLAN_DFT_DUMP_FRAME
extern oal_uint32  dmac_rx_compare_frametype_and_rxq(
...
extern oal_void dmac_ant_rx_frame(hal_to_dmac_device_stru *pst_hal_dev, dmac_rx_ctl_stru *pst_cb_ctrl);
extern oal_void dmac_ant_tbtt_process(hal_to_dmac_device_stru *pst_hal_dev);
extern oal_void  dmac_rx_data_user_is_null(mac_vap_stru *pst_mac_vap, mac_ieee80211_frame_stru *pst_frame_hdr);
