...
#endif
#if ((_PRE_MULTI_CORE_MODE_OFFLOAD_DMAC == _PRE_MULTI_CORE_MODE) && !defined(_PRE_WLAN_PROFLING_MIPS)) || defined(_PRE_WLAN_MAC_BUGFIX_RESET)
...
#if (_PRE_MULTI_CORE_MODE_OFFLOAD_DMAC != _PRE_MULTI_CORE_MODE)
OAL_STATIC oal_uint32 dmac_reset_save_txbf_lut(hal_to_dmac_device_stru* pst_hal_device,oal_uint32* pst_txbf_lut);
OAL_STATIC oal_uint32 dmac_reset_restore_txbf_lut(hal_to_dmac_device_stru *pst_hal_device, oal_uint32* pst_txbf_lut);
OAL_STATIC oal_uint32 dmac_reset_save_smartant_lut(hal_to_dmac_device_stru* pst_hal_device,oal_uint32* pst_smartant_lut);
OAL_STATIC oal_uint32 dmac_reset_restore_smartant_lut(hal_to_dmac_device_stru* pst_hal_device, oal_uint32* pst_smartant_lut);
OAL_STATIC oal_uint32 dmac_reset_restore_cipher_lut(mac_device_stru* pst_mac_device);
OAL_STATIC oal_uint32 dmac_reset_restore_ba_lut(hal_to_dmac_device_stru* pst_hal_device,oal_uint32* pst_ba_lut);
OAL_STATIC oal_uint32 dmac_reset_save_ba_lut(hal_to_dmac_device_stru* pst_hal_device,oal_uint32* pst_ba_lut);
OAL_STATIC oal_uint32 dmac_reset_restore_seq_lut(mac_device_stru* pst_mac_device, hal_to_dmac_device_stru *pst_hal_device, oal_uint32 *pst_qos_seq,oal_uint32 *pst_nonqos_seq);
...
OAL_STATIC  oal_uint32 dmac_reset_lut_init(oal_void)
{
   oal_uint8 uc_max_lut_index = mac_chip_get_max_active_user();
   ...
   {
       g_st_dmac_reset_mng.pst_sequence_qos = (oal_uint32*)OAL_MEM_ALLOC(OAL_MEM_POOL_ID_LOCAL,uc_max_lut_index*WLAN_TID_MAX_NUM*OAL_SIZEOF(oal_uint32),OAL_TRUE);
   ...
   {
       g_st_dmac_reset_mng.pst_rx_pn_ucast = (oal_uint32*)OAL_MEM_ALLOC(OAL_MEM_POOL_ID_LOCAL,WLAN_TID_MAX_NUM*uc_max_lut_index*2*OAL_SIZEOF(oal_uint32),OAL_TRUE);
       ...
       g_st_dmac_reset_mng.pst_tx_pn_ucast = (oal_uint32*)OAL_MEM_ALLOC(OAL_MEM_POOL_ID_LOCAL,uc_max_lut_index*2*OAL_SIZEOF(oal_uint32),OAL_TRUE);
   ...
   {
       g_st_dmac_reset_mng.pst_txbf = (oal_uint32*)OAL_MEM_ALLOC(OAL_MEM_POOL_ID_LOCAL,uc_max_lut_index*OAL_SIZEOF(oal_uint32),OAL_TRUE);
   ...
   {
       g_st_dmac_reset_mng.pst_smartant = (oal_uint32*)OAL_MEM_ALLOC(OAL_MEM_POOL_ID_LOCAL,uc_max_lut_index*OAL_SIZEOF(oal_uint32),OAL_TRUE);
...
OAL_STATIC oal_uint32 dmac_reset_save_tx_queue(hal_to_dmac_device_stru *pst_hal_device)
{
    ...
    for (uc_q_id = 0; uc_q_id < HAL_TX_QUEUE_NUM; uc_q_id++)
    {
        oal_memset(pst_fake_queue + uc_q_id, 0, OAL_SIZEOF(hal_tx_dscr_queue_header_stru));
        oal_dlist_init_head(&pst_fake_queue[uc_q_id].st_header);
    }
...
oal_uint32  dmac_reset_hw(mac_device_stru* pst_device, hal_to_dmac_device_stru *pst_hal_device, oal_uint8* pst_param)
{
        ...
        for (uc_vap_idx = 0; uc_vap_idx < pst_device->uc_vap_num; uc_vap_idx++)
        {
          ...
          if (WLAN_VAP_MODE_BSS_STA == pst_mac_sta->en_vap_mode)
          {
              ...
              hal_set_primary_channel(pst_hal_device,
                                    ...
                                    pst_mac_sta->st_channel.uc_chan_idx,
...
oal_uint32  dmac_reset_hw(mac_device_stru* pst_device, hal_to_dmac_device_stru *pst_hal_device, oal_uint8* pst_param)
{
    ...
    if (pst_reset_para->uc_reset_mac_reg)
    {
       ...
       dmac_reset_save_ba_lut(pst_hal_device,g_st_dmac_reset_mng.pst_ba_rx);
       ...
       dmac_reset_save_txbf_lut(pst_hal_device,g_st_dmac_reset_mng.pst_txbf);

       dmac_reset_save_smartant_lut(pst_hal_device,g_st_dmac_reset_mng.pst_smartant);
    ...
    if(pst_reset_para->uc_reset_mac_reg)
    {
       ...
       dmac_reset_restore_ba_lut(pst_hal_device,g_st_dmac_reset_mng.pst_ba_rx);

       dmac_reset_restore_seq_lut(pst_device, pst_hal_device, g_st_dmac_reset_mng.pst_sequence_qos, &ul_sequence_nonqos);

       dmac_reset_restore_txbf_lut(pst_hal_device,g_st_dmac_reset_mng.pst_txbf);

       dmac_reset_restore_smartant_lut(pst_hal_device,g_st_dmac_reset_mng.pst_smartant);
    ...
    if(g_st_dmac_reset_mng.bit_seq_lut_reset)
    {
        ...
        for (uc_vap_idx = 0; uc_vap_idx < pst_mac_device->uc_vap_num; uc_vap_idx++)
        {
            ...
            OAL_DLIST_SEARCH_FOR_EACH(pst_entry, &(pst_mac_vap->st_mac_user_list_head))
            {
                ...
                {
                    OAM_WARNING_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{dmac_reset_save_seq_lut::pst_user_tmp null.");
                    return OAL_ERR_CODE_PTR_NULL;
                }
                ...
                pst_hal_device = dmac_user_get_hal_device(&(pst_dmac_user_tmp->st_user_base_info));
                if (OAL_PTR_NULL == pst_hal_device)
                {
                    OAM_WARNING_LOG1(0, OAM_SF_COEX, "{dmac_reset_save_seq_lut::vap id [%d],dmac_user_get_hal_device null}",pst_mac_vap->uc_vap_id);
                    continue;
                }
                if(pst_dmac_user_tmp->st_user_base_info.st_cap_info.bit_qos)
                {
                    for(uc_tid_loop = 0;uc_tid_loop<WLAN_TID_MAX_NUM;uc_tid_loop++)
                    {
                         ...
                         hal_get_tx_sequence_num(pst_hal_device,
    ...
    if(g_st_dmac_reset_mng.bit_seq_lut_reset)
    {
        ...
        for (uc_vap_idx = 0; uc_vap_idx < pst_mac_device->uc_vap_num; uc_vap_idx++)
        {
            ...
            OAL_DLIST_SEARCH_FOR_EACH(pst_entry, &(pst_mac_vap->st_mac_user_list_head))
            {
                ...
                if (OAL_PTR_NULL == pst_user_tmp)
                {
                    OAM_WARNING_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{dmac_reset_restore_seq_lut::pst_user_tmp null.");
                    return OAL_ERR_CODE_PTR_NULL;
                }
                pst_dmac_user_tmp = MAC_GET_DMAC_USER(pst_user_tmp);
                ...
                if(pst_dmac_user_tmp->st_user_base_info.st_cap_info.bit_qos)
                {
                    for(uc_tid_loop = 0;uc_tid_loop<WLAN_TID_MAX_NUM;uc_tid_loop++)
                    {
                         ...
                         hal_set_tx_sequence_num(pst_hal_device,
                                                pst_dmac_user_tmp->uc_lut_index,
                                                uc_tid_loop,
                                                1,
                                                ul_reg_value,
                                                      ...
                                                      oal_uint32* pst_tx_pn_ucast,oal_uint32* pst_tx_pn_mcast)
{
    ...
    OAL_MEMZERO(&st_pn_lut_cfg, OAL_SIZEOF(hal_pn_lut_cfg_stru));
    if(g_st_dmac_reset_mng.bit_pn_lut_reset)
    {
        ...
        for (uc_vap_idx = 0; uc_vap_idx < pst_mac_device->uc_vap_num; uc_vap_idx++)
        {
            ...
            OAL_DLIST_SEARCH_FOR_EACH(pst_entry, &(pst_dmac_vap->st_vap_base_info.st_mac_user_list_head))
            {
                ...
                if (OAL_PTR_NULL == pst_user_tmp)
                {
                    OAM_WARNING_LOG0(pst_dmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_ANY, "{dmac_reset_save_pn_lut::pst_user_tmp null.");
                    return OAL_ERR_CODE_PTR_NULL;
                }
...

                {
                 ...
                 hal_get_tx_pn(pst_dmac_vap->pst_hal_device,&st_pn_lut_cfg);
                ...
                *(pst_curr_entry + 1)   = st_pn_lut_cfg.ul_pn_lsb;
                ...
                for(uc_tid_loop = 0; uc_tid_loop < WLAN_TID_MAX_NUM; uc_tid_loop++)
                {
                     ...
                     hal_get_rx_pn(pst_dmac_vap->pst_hal_device,&st_pn_lut_cfg);
    ...
    if(g_st_dmac_reset_mng.bit_pn_lut_reset)
    {
        ...
        for (uc_vap_idx = 0; uc_vap_idx < pst_mac_device->uc_vap_num; uc_vap_idx++)
        {
            ...
            OAL_DLIST_SEARCH_FOR_EACH(pst_entry, &(pst_dmac_vap->st_vap_base_info.st_mac_user_list_head))
            {
                ...
                if (OAL_PTR_NULL == pst_user_tmp)
                {
                    OAM_WARNING_LOG0(pst_dmac_vap->st_vap_base_info.uc_vap_id, OAM_SF_ANY, "{dmac_reset_restore_pn_lut::pst_user_tmp null.");
                    return OAL_ERR_CODE_PTR_NULL;
                }
...

                {
                    /* 单播tx pn */
                     ...
                     hal_set_tx_pn(pst_dmac_vap->pst_hal_device,&st_pn_lut_cfg);
                }
                ...
                for(uc_tid_loop = 0;uc_tid_loop < WLAN_TID_MAX_NUM;uc_tid_loop++)
                {
                     ...
                     hal_set_rx_pn(pst_dmac_vap->pst_hal_device,&st_pn_lut_cfg);
...
OAL_STATIC oal_uint32 dmac_reset_restore_cipher_lut(mac_device_stru* pst_mac_device)
{
    ...
    if(g_st_dmac_reset_mng.bit_key_lut_reset)
    {
        ...
        for (uc_vap_idx = 0; uc_vap_idx < pst_mac_device->uc_vap_num; uc_vap_idx++)
        {
            ...
            {
                OAM_WARNING_LOG1(0, OAM_SF_DBAC, "{dmac_reset_restore_cipher_lut::pst_mac_user[%d] is NULL!}",
            ...
            OAL_DLIST_SEARCH_FOR_EACH(pst_entry, &(pst_mac_vap->st_mac_user_list_head))
            {
                ...
                {
                    OAM_WARNING_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{dmac_reset_restore_cipher_lut::pst_user null.");
                    return OAL_ERR_CODE_PTR_NULL;
                }
...
OAL_STATIC oal_uint32 dmac_reset_save_txbf_lut(hal_to_dmac_device_stru* pst_hal_device,oal_uint32* pst_txbf_lut)
{
    ...
    oal_uint8                uc_user_loop = 0;
    oal_uint8                uc_max_user_loop = 0;
    oal_uint32              *pst_current_entry;

    if(g_st_dmac_reset_mng.bit_txbf_lut_reset)
    {
        uc_max_user_loop = mac_chip_get_max_active_user();

        for(uc_user_loop = 0;uc_user_loop < uc_max_user_loop; uc_user_loop++)
        {
            pst_current_entry = pst_txbf_lut + uc_user_loop;
            hal_get_txbf_lut_info(pst_hal_device, uc_user_loop, pst_current_entry);
        }
    }
 #endif
    return  OAL_SUCC;
...
OAL_STATIC oal_uint32 dmac_reset_restore_txbf_lut(hal_to_dmac_device_stru *pst_hal_device, oal_uint32* pst_txbf_lut)
{
    ...
    if(g_st_dmac_reset_mng.bit_txbf_lut_reset)
    {
        ...
        {
            pst_current_entry = pst_txbf_lut + uc_user_loop;
            hal_set_txbf_lut_info(pst_hal_device, uc_user_loop, *pst_current_entry);
        }
    }
#endif
    return  OAL_SUCC;
...
OAL_STATIC oal_uint32 dmac_reset_save_smartant_lut(hal_to_dmac_device_stru* pst_hal_device,oal_uint32* pst_smartant_lut)
{
    ...
    if(g_st_dmac_reset_mng.bit_smartant_lut_reset)
    {
        ...
        for(uc_user_loop = 0;uc_user_loop < uc_max_user_loop; uc_user_loop++)
        {
            pst_current_entry = pst_smartant_lut + uc_user_loop;
            hal_get_smart_antenna_value(pst_hal_device, uc_user_loop, pst_current_entry);
        }
    }
    return  OAL_SUCC;
}
...
OAL_STATIC oal_uint32 dmac_reset_restore_smartant_lut(hal_to_dmac_device_stru* pst_hal_device, oal_uint32* pst_smartant_lut)
{
    ...
    if(g_st_dmac_reset_mng.bit_smartant_lut_reset)
    {
        ...
        {
            pst_current_entry = pst_smartant_lut + uc_user_loop;
            hal_set_smart_antenna_value(pst_hal_device, uc_user_loop, (oal_uint16)*pst_current_entry);
        }
    }
    return  OAL_SUCC;
}
    ...
    if(g_st_dmac_reset_mng.bit_peer_addr_lut_reset)
    {
        ...
        for (uc_vap_idx = 0; uc_vap_idx < pst_mac_device->uc_vap_num; uc_vap_idx++)
        {
            ...
            OAL_DLIST_SEARCH_FOR_EACH(pst_entry, &(pst_mac_vap->st_mac_user_list_head))
            {
                ...
                if (OAL_PTR_NULL == pst_user)
                {
                    OAM_WARNING_LOG0(pst_mac_vap->uc_vap_id, OAM_SF_ANY, "{dmac_reset_restore_peer_addr_lut::pst_user_tmp null.");
                    return OAL_ERR_CODE_PTR_NULL;
                }
               ...
               hal_ce_add_peer_macaddr(pst_dmac_vap->pst_hal_device,pst_dmac_user->uc_lut_index,pst_dmac_user->st_user_base_info.auc_user_mac_addr);
...
{
    hal_rx_destroy_dscr_queue(pst_hal);
...
OAL_STATIC oal_void dmac_reset_restore_tsf(mac_device_stru* pst_mac_device,oal_uint32* pst_tsf_array,oal_time_us_stru *pst_time_record)
{
    ...
    /*计算时差*/
    ul_diff_time_us = (oal_uint32)OAL_TIME_GET_RUNTIME(DMAC_TIME_USEC_INT64(pst_time_record), DMAC_TIME_USEC_INT64(&st_now_time));
...
oal_void dmac_reset_debug_sequence_lut(hal_to_dmac_device_stru* pst_hal_device)
{
...
oal_void dmac_reset_debug_ba_lut(hal_to_dmac_device_stru* pst_hal_device)
{
    oal_uint8                uc_index_loop;
...
oal_void dmac_reset_debug_pn_lut(hal_to_dmac_device_stru* pst_hal_device)
{
    oal_uint8                uc_user_loop;
    oal_uint8                uc_max_user_loop;
    oal_uint8                uc_tid_loop;
    oal_uint8                uc_vap_idx;
    hal_pn_lut_cfg_stru      st_pn_lut_cfg;
    oal_file                *pst_fs = OAL_PTR_NULL;
...
oal_void dmac_reset_debug_init(oal_void)
{
    ...
    g_st_dmac_reset_mng.pst_debug_file = oal_kernel_file_open((oal_uint8 *)DMAC_RESET_DUMP_LUT_PATH,OAL_O_RDWR|OAL_O_CREAT|OAL_O_APPEND);
...
oal_void dmac_reset_debug_to_file(oal_uint8 *pst_str)
{
    oal_kernel_file_write(g_st_dmac_reset_mng.pst_debug_file,pst_str,OAL_STRLEN((oal_int8 *)pst_str));
}


oal_void dmac_reset_debug_all(hal_to_dmac_device_stru* pst_hal_device,dmac_reset_para_stru* pst_debug_para)
{
    ...
    {
        /*输出所有的*/
        hal_reset_reg_restore(pst_hal_device,HAL_RESET_HW_TYPE_DUMP_MAC);
        hal_reset_reg_restore(pst_hal_device,HAL_RESET_HW_TYPE_DUMP_PHY);
        dmac_reset_debug_sequence_lut(pst_hal_device);
        dmac_reset_debug_ba_lut(pst_hal_device);
        dmac_reset_debug_pn_lut(pst_hal_device);
