...
/*****************************************************************************
  10 函数声明
*****************************************************************************/
extern oal_uint32  dmac_reset_hw(mac_device_stru* pst_device, hal_to_dmac_device_stru *pst_hal_device, oal_uint8* pst_param);
extern oal_void dmac_reset_debug_all(hal_to_dmac_device_stru* pst_hal_device,dmac_reset_para_stru* pst_debug_para);
