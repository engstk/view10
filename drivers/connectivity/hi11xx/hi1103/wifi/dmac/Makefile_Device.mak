...
DMAC_DRV_TEST_DIR=$(WIFI_SRCDIR)\dmac\dmac_verify
...
obj-m :=dmac.o
dmac-objs := $(DMAC_SCRDIR)\dmac_main.o $(DMAC_SCRDIR)\dmac_mgmt_classifier.o $(DMAC_SCRDIR)\dmac_psm_ap.o $(DMAC_SCRDIR)\dmac_rx_data.o $(DMAC_SCRDIR)\dmac_tid.o $(DMAC_SCRDIR)\dmac_tx_bss_comm.o $(DMAC_SCRDIR)\dmac_smps.o $(DMAC_SCRDIR)\dmac_opmode.o $(DMAC_SCRDIR)\dmac_m2s.o \
			 ...
			 $(DMAC_SCRDIR)\dmac_dft.o $(DMAC_SCRDIR)\dmac_device.o $(DMAC_SCRDIR)\dmac_resource.o $(DMAC_SCRDIR)\dmac_ap_pm.o $(DMAC_SCRDIR)\mac_pm.o  $(DMAC_SCRDIR)\dmac_hcc_adapt.o $(DMAC_SCRDIR)\mac_board.o $(DMAC_SCRDIR)\mac_data.o $(DMAC_SCRDIR)\dmac_psm_sta.o $(DMAC_SCRDIR)\dmac_sta_pm.o $(DMAC_SCRDIR)\dmac_ftm.o
dmac-objs += $(DMAC_SCRDIR)\dmac_p2p.o $(DMAC_SCRDIR)\dmac_uapsd_sta.o $(DMAC_SCRDIR)\dmac_pm_sta.o $(DMAC_SCRDIR)\dmac_power.o $(DMAC_SCRDIR)\dmac_csa_sta.o $(DMAC_SCRDIR)\dmac_radar.o
...
dmac-dump-objs += $(DMAC_DRV_TEST_DIR)\dmac_test_main.o $(DMAC_DRV_TEST_DIR)\dmac_frame_filter_test.o
ifeq ($(WLAN_CHIP_TEST_ENABLE), y)
dmac-dump-objs += $(DMAC_DRV_TEST_DIR)\dmac_test_main.o $(DMAC_DRV_TEST_DIR)\dmac_lpm_test.o $(DMAC_DRV_TEST_DIR)\dmac_frame_filter_test.o $(DMAC_DRV_TEST_DIR)\dmac_test_sch.o $(DMAC_DRV_TEST_DIR)\dmac_wmm_test.o
endif
