...
oal_uint32  dmac_test_encap_mgmt_atim(mac_vap_stru *pst_mac_vap, oal_uint8 *puc_buff, oal_uint8 *puc_param, oal_uint32 ul_param_len)
{
    ...
    /* 设置地址2为自己的MAC地址 */
    oal_set_mac_addr(puc_buff + WLAN_HDR_ADDR2_OFFSET, mac_mib_get_StationID(pst_mac_vap));
...
oal_uint32  dmac_test_encap_ba(mac_vap_stru *pst_mac_vap, oal_uint8 *puc_buff, oal_uint8 *puc_param, oal_uint32 ul_param_len)
{
    ...
    oal_set_mac_addr(puc_buff + 10, mac_mib_get_StationID(pst_mac_vap));
    /* BAR Control field */
...
oal_uint32  dmac_test_encap_mgmt_action(mac_vap_stru *pst_mac_vap, oal_uint8 *puc_buff, oal_uint8 *puc_param, oal_uint32 ul_param_len)
{
    ...
    oal_memcopy(puc_payload_addr,pst_param->uc_frame_body, pst_param->uc_frame_body_length);
...
#ifdef _PRE_WLAN_FEATURE_FTM
    pst_encap_fun[MAC_TEST_FTM]         =   dmac_test_encap_mgmt_ftm;
#endif
#endif
    pst_encap_fun[MAC_TEST_MGMT_ACTION] = dmac_test_encap_mgmt_action;
    pst_encap_fun[MAC_TEST_MGMT_BEACON_INCLUDE_IE] = OAL_PTR_NULL;
    return OAL_SUCC;
}
