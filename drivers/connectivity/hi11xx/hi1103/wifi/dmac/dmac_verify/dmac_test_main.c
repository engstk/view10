...
oal_void dmac_test_set_addr4(hal_tx_dscr_stru * pst_tx_dscr)
{
    ...
    pst_qos = (mac_ieee80211_qos_frame_stru *)MAC_GET_CB_FRAME_HEADER_ADDR(pst_tx_ctrl);
    ...
    /* 设置描述符，帧头长度为4地址长度  */
    oal_memcopy(MAC_GET_CB_FRAME_HEADER_ADDR(pst_tx_ctrl), &st_qos_addr4, OAL_SIZEOF(mac_ieee80211_qos_frame_addr4_stru));
