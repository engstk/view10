...
typedef struct
{
    ...
    oal_uint8                         us_rc_flag;
}__OAL_DECLARE_PACKED dmac_acs_channel_stru;
...
typedef struct
{
    ...
    wlan_channel_band_enum_uint8        en_band;          /* VAP的频段 */
...
typedef struct
{
    oal_bool_enum_uint8                 uc_switch;
    oal_uint8                           uc_cur_bw;
    oal_uint8                           uc_40_user_count;
    oal_uint8                           uc_resv;
}dmac_acs_2040_user;
...
#endif
extern oal_void    dmac_acs_channel_meas_comp_handler(hal_to_dmac_device_stru *pst_hal_device, hal_ch_statics_irq_event_stru *pst_mac_stats_result);
...
extern oal_uint32 dmac_acs_2040_user_set_switch(oal_bool_enum_uint8 en_value, mac_vap_stru *pst_mac_vap);
#endif
