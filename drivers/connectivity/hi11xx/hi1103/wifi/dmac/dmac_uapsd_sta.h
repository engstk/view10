...
/*****************************************************************************
  9 OTHERS定义
*****************************************************************************/
extern oal_uint8 dmac_is_uapsd_capable(dmac_vap_stru *pst_dmac_vap);
extern oal_uint8 dmac_is_trigger_enabled(dmac_vap_stru *pst_dmac_vap, oal_uint8  uc_tid);
...
extern oal_uint8 dmac_get_highest_trigger_enabled_priority(dmac_vap_stru *pst_dmac_vap);
extern oal_uint8 dmac_can_sta_doze_prot(dmac_vap_stru *pst_dmac_vap);
