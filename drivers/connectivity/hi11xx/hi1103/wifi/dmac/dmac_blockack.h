...
#define DMAC_TX_BUF_BITMAP_IS_SET(_bitmap, _idx) \
    ((_bitmap[_idx >> DMAC_TX_BUF_BITMAP_LOG2_WORD_SIZE] & \
    ((oal_uint32)1 << (_idx & DMAC_TX_BUF_BITMAP_WORD_MASK))) != 0)

/* 判断index为n 在bitmap中的bit位是否是1 */
#define DMAC_BA_ISSET(_bm, _n)        (((_n) < (DMAC_BA_BMP_SIZE)) &&          \
                                     ((_bm)[(_n) >> 5] & ((oal_uint32)1 << ((_n) & 31))))
...
typedef oal_uint16  (*min_len_ht)(hal_tx_txop_alg_stru *pst_txop_alg,
...
typedef oal_uint16  (*min_len_vht)(hal_tx_txop_alg_stru *pst_txop_alg,
                                                                wlan_phy_protocol_enum_uint8    en_protocl_mode,
                                                                hal_channel_assemble_enum_uint8 en_channel_bandwidth,
                                                                oal_bool_enum_uint8 en_short_gi_enable);

typedef oal_uint32  (*p_dmac_ba_send_bar_cb)(dmac_ba_tx_stru *pst_tx_ba_handle, dmac_user_stru *pst_dmac_user, dmac_tid_stru *pst_tid_queue);

typedef struct
{
    min_len_ht   min_len_ht_cb;
    min_len_vht  min_len_vht_cb;
    p_dmac_ba_send_bar_cb  dmac_ba_send_bar_cb;

}dmac_ba_cb;
extern  dmac_ba_cb g_st_dmac_ba_rom_cb;
/*****************************************************************************
  8 UNION定义
*****************************************************************************/
...
OAL_STATIC OAL_INLINE oal_void dmac_ba_addto_baw(dmac_ba_tx_stru *pst_tx_ba_handle)
{
    oal_uint16    us_index;
...
OAL_STATIC OAL_INLINE oal_void  dmac_ba_update_baw(dmac_ba_tx_stru *pst_tx_ba_handle, oal_uint16 us_seqno)
{
    ...
    ul_cindex = (oal_uint32)((pst_tx_ba_handle->us_baw_head + us_index) & (DMAC_TID_MAX_BUFS - 1));
...
extern oal_uint16  dmac_ba_get_min_len_ht(hal_tx_txop_alg_stru *pst_txop_alg,
                                                                wlan_phy_protocol_enum_uint8    en_protocl_mode,
                                                                hal_channel_assemble_enum_uint8 en_channel_bandwidth,
                                                                oal_bool_enum_uint8);
extern oal_uint16  dmac_ba_get_min_len_vht(hal_tx_txop_alg_stru *pst_txop_alg,
                                                                wlan_phy_protocol_enum_uint8    en_protocl_mode,
                                                                hal_channel_assemble_enum_uint8 en_channel_bandwidth,
                                                                oal_bool_enum_uint8);
extern oal_void  dmac_ba_reset_rx_handle(mac_device_stru *pst_device, dmac_user_stru *pst_dmac_user, dmac_ba_rx_stru *pst_ba_rx_hdl);
extern oal_void  dmac_ba_reset_tx_handle(mac_device_stru *pst_device, dmac_ba_tx_stru **ppst_tx_ba, oal_uint8 uc_tid);
extern oal_uint32  dmac_ba_check_rx_aggr(mac_vap_stru *pst_vap, mac_ieee80211_frame_stru *pst_frame_hdr);
...
extern oal_void dmac_clear_tx_qos_seq_num(dmac_vap_stru *pst_dmac_vap, dmac_user_stru *pst_dmac_user);
extern oal_void dmac_clear_tx_nonqos_seq_num(dmac_vap_stru *pst_dmac_vap);
#ifdef _PRE_WLAN_FEATURE_AMPDU_TX_HW
extern oal_void dmac_ba_set_ampdu_ctrl(mac_vap_stru *pst_mac_vap, oal_uint8 uc_enable_tx_hw, oal_uint8 uc_snd_type);
extern oal_void dmac_ba_tx_ampdu_switch(mac_vap_stru *pst_mac_vap, oal_uint8 uc_enable_tx_hw, oal_uint8 uc_snd_type);
#endif
