...
OAL_STATIC oal_uint32  dmac_user_track_thrput_timeout(oal_void *p_arg)
{
    ...
    {
        us_rx_ampdu_num = pst_hal_device->st_user_track_rx_ampdu_stat.us_rx_ampdu_num;
        ul_rx_mpdu_in_ampdu = pst_hal_device->st_user_track_rx_ampdu_stat.ul_rx_mpdu_in_ampdu;
        ...
        /* 清零统计 */
        pst_hal_device->st_user_track_rx_ampdu_stat.us_rx_ampdu_num = 0;
        pst_hal_device->st_user_track_rx_ampdu_stat.ul_rx_mpdu_in_ampdu = 0;
    }
...
{
    dmac_user_stru                       *pst_dmac_user = MAC_GET_DMAC_USER(pst_mac_user);
    hal_to_dmac_device_stru              *pst_hal_device = OAL_PTR_NULL;
    ...
    if (OAL_PTR_NULL == pst_hal_device)
    {
        OAM_WARNING_LOG1(0, OAM_SF_ANY, "{dmac_user_track_report_usr_thrput_stat::pst_hal_device null, device_id: %d.}", pst_mac_user->uc_device_id);
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    /* 打开统计接收平均聚合长度开关 */
    pst_hal_device->st_user_track_rx_ampdu_stat.en_flg = OAL_TRUE;
...
oal_uint32  dmac_user_track_clear_usr_thrput_stat(mac_user_stru  *pst_mac_user)
{
    ...
    if (OAL_PTR_NULL == pst_hal_device)
    {
        OAM_WARNING_LOG1(0, OAM_SF_COEX, "{dmac_user_track_clear_usr_thrput_stat::dmac_user_get_hal_device null, device_id: %d.}", pst_mac_user->uc_device_id);
        return OAL_ERR_CODE_PTR_NULL;
    }
    ...
    pst_hal_device->st_user_track_rx_ampdu_stat.en_flg = OAL_FALSE;
