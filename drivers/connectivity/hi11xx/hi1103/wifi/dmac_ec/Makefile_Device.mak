...
DMAC_SCRDIR=$(WIFI_SRCDIR)\dmac_ec
...
obj-m :=dmac.o
dmac-ec-objs := dmac_main_rom.o dmac_mgmt_classifier_rom.o dmac_psm_ap_rom.o dmac_rx_data_rom.o dmac_tid_rom.o dmac_tx_bss_comm_rom.o dmac_smps_rom.o dmac_opmode_rom.o dmac_m2s_rom.o \
...
dmac-ec-objs += dmac_p2p_rom.o dmac_uapsd_sta_rom.o dmac_pm_sta_rom.o dmac_power_rom.o
dmac-ec-objs += dmac_btcoex_rom.o dmac_ltecoex_verify_rom.o dmac_arp_offload_rom.o dmac_auto_adjust_freq_rom.o
dmac-ec-objs += mac_data_rom.o mac_frame_rom.o mac_ie_rom.o mac_regdomain_rom.o mac_device_rom.o mac_resource_rom.o mac_board_rom.o mac_user_rom.o mac_vap_rom.o
dmac-ec-objs := $(addprefix $(DMAC_SCRDIR)\,$(dmac-ec-objs))
dmac-ec-dump-objs := $(dmac-ec-objs)
