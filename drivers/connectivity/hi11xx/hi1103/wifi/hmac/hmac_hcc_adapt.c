...
oal_uint32  g_ul_print_wakeup_data = OAL_FALSE;
oal_uint8   g_uc_print_host_wakeup_dev = OAL_FALSE;
#endif
...
#ifdef _PRE_WLAN_WAKEUP_SRC_PARSE
oal_void hmac_print_host_wkup_dev_en(oal_bool_enum_uint8 uc_en)
{
    g_uc_print_host_wakeup_dev = uc_en;
}
#endif
                                             ...
                                             hcc_netbuf_stru* pst_hcc_netbuf, oal_uint8 *pst_context)
{
    ...
    if(OAL_TRUE == g_ul_pm_wakeup_event)
    {
        ...
        {
          g_ul_print_wakeup_data = OAL_TRUE;
        }
    }
#endif
