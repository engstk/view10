...
oal_void hmac_uapsd_update_user_para (oal_uint8  *puc_payload,oal_uint8  uc_sub_type,oal_uint32 ul_msg_len,
                                            hmac_user_stru *pst_hmac_user)
{
    ...
    puc_wmm_ie = mac_get_wmm_ie(puc_payload, (oal_uint16)ul_msg_len);
