...
OAL_STATIC oal_void hmac_event_fsm_tx_adapt_subtable_register(oal_void)
{
    ...
    g_ast_dmac_wlan_ctx_event_sub_table[DMAC_WLAN_CTX_EVENT_SUB_TYPE_DPD_HMAC2DMAC].p_tx_adapt_func  = hmac_send_event_netbuf_tx_adapt;
...
oal_void hmac_register_pm_callback(oal_void)
{
    ...
    if(pst_wifi_srv_handler)
    {
        ...
        pst_wifi_srv_handler->p_host_wkup_dev_print_en_func = hmac_print_host_wkup_dev_en;
        #endif
    }
    else
    {
