                ...
                mac_cfg_add_vap_param_stru *pst_param)
{
...
#endif
    pst_hmac_vap->bit_rx_ampduplusamsdu_active = OAL_FALSE;
    ...
    switch(pst_param->en_vap_mode)
    {
		...
		#endif
        #if (_PRE_WLAN_FEATURE_BLACKLIST_LEVEL != _PRE_WLAN_FEATURE_BLACKLIST_NONE)
            mac_blacklist_get_pointer(uc_device_id, uc_chip_id, &(pst_hmac_vap->pst_blacklist_info));
            if(OAL_PTR_NULL != pst_hmac_vap->pst_blacklist_info)
            {
                oal_memset(pst_hmac_vap->pst_blacklist_info, 0, OAL_SIZEOF(mac_blacklist_info_stru));
            }
        #endif
        ...
        #endif
        #if (_PRE_WLAN_FEATURE_BLACKLIST_LEVEL != _PRE_WLAN_FEATURE_BLACKLIST_NONE)
            pst_hmac_vap->pst_blacklist_info = OAL_PTR_NULL;
        #endif
    ...
    pst_hmac_vap->bit_11k_enable   = OAL_TRUE;
#ifdef _PRE_WLAN_FEATURE_11K_EXTERN
    ...
    pst_hmac_vap->bit_11v_enable   = OAL_TRUE;
#endif

#ifdef _PRE_WLAN_FEATURE_11R
    pst_hmac_vap->bit_11r_enable   = OAL_TRUE;
#endif
