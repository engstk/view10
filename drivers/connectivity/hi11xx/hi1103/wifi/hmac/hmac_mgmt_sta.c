...
OAL_STATIC oal_void hmac_sta_up_update_he_edca_params_mib(hmac_vap_stru  *pst_hmac_sta, oal_uint8  *puc_payload)
{
    oal_uint8               uc_aifsn;
    oal_uint8               uc_aci;
    oal_uint8               uc_ecwmin;
    ...
    */
    uc_mu_edca_timer = puc_payload[2];
    ...
    if (uc_aci < WLAN_WME_AC_BUTT)
    {
        ...
        mac_mib_set_QAPEDCATableTXOPLimit(&pst_hmac_sta->st_vap_base_info, uc_aci, ul_txop_limit);
                    ...
                    hmac_user_stru          *pst_hmac_user)
{
    ...
    if (OAL_PTR_NULL != puc_ie)
    {
        ...
        {
            hmac_sta_up_update_he_edca_params_mib(pst_hmac_sta,(oal_uint8 *)&(st_mu_edca_value.ast_mu_ac_parameter[uc_ac_num_loop]));
        }
...
oal_uint32 hmac_sta_update_join_req_params(hmac_vap_stru *pst_hmac_vap, hmac_join_req_stru *pst_join_req)
{
    ...
    #ifdef _PRE_WLAN_FEATURE_11AX
        mac_mib_set_HEOptionImplemented(pst_mac_vap,pst_join_req->st_bss_dscr.en_he_capable);
    #endif
        ...
        case MAC_ACTION_CATEGORY_PUBLIC:
        {
            ...
            switch (puc_data[MAC_ACTION_OFFSET_ACTION])
            {
                ...
                /* 并用hmac_rx_mgmt_send_to_host接口上报 */
                    ...
                    if (0 == oal_memcmp(puc_data  + 2, g_auc_huawei_oui, MAC_OUI_LEN))
                    {
                       hmac_huawei_action_process(pst_hmac_vap, pst_netbuf, puc_data[2 + MAC_OUI_LEN]);
                    }
            #endif  /* _PRE_WLAN_FEATURE_FTM */
                    break;
