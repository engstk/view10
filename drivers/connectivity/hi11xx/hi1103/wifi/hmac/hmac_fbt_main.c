...
void hmac_fbt_sta_scan(mac_vap_stru *pst_mac_vap)
{
    ...
    mac_get_channel_idx_from_num(en_channel_band,pst_fbt_scan_mgmt->uc_scan_channel,&uc_chan_idx);
    ...
    hmac_scan_proc_scan_req_event(pst_hmac_vap, &st_mac_scan_param);
