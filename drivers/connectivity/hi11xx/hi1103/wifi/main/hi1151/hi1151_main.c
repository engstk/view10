...
oal_int32  hi1151_main_init(oal_void)
{
    ...
    ul_return = oal_main_init();
    if (OAL_SUCC != ul_return)
    {
        OAL_IO_PRINT("oal_main_init failed, ret = %d", ul_return);
        return ul_return;
    }

    ul_return = oam_main_init();
    if (OAL_SUCC != ul_return)
    {
        OAL_IO_PRINT("oam_main_init failed, ret = %d", ul_return);
        return ul_return;
    }
    ...
    ul_return = frw_main_init();
    if (OAL_SUCC != ul_return)
    {
        OAL_IO_PRINT("frw_main_init failed, ret = %d", ul_return);
        return ul_return;
    }
    ...
    ul_return = hmac_main_init();
    if (OAL_SUCC != ul_return)
    {
        OAL_IO_PRINT("hmac_main_init failed, ret = %d", ul_return);
        return ul_return;
    }

    ul_return = wal_main_init();
    if (OAL_SUCC != ul_return)
    {
        OAL_IO_PRINT("wal_main_init failed, ret = %d", ul_return);
        return ul_return;
    }
