...
oal_uint32  wal_asoc_comp_proc_sta(frw_event_mem_stru *pst_event_mem)
{
    ...
    if (OAL_SUCC != ul_ret)
    {
        OAM_WARNING_LOG1(pst_event->st_event_hdr.uc_vap_id, OAM_SF_ASSOC, "{wal_asoc_comp_proc_sta::oal_cfg80211_connect_result fail[%d]!}\r\n", ul_ret);
    }
#endif
    oal_free(pst_asoc_rsp->puc_asoc_rsp_ie_buff);
    pst_asoc_rsp->puc_asoc_rsp_ie_buff = OAL_PTR_NULL;
...
oal_uint32  wal_disasoc_comp_proc_sta(frw_event_mem_stru *pst_event_mem)
{
    ...
    if (OAL_SUCC != ul_ret)
    {
        OAM_WARNING_LOG1(pst_event->st_event_hdr.uc_vap_id, OAM_SF_ASSOC, "{wal_disasoc_comp_proc_sta::oal_cfg80211_disconnected fail[%d]!}\r\n", ul_ret);
        return ul_ret;
    }
#endif
...
oal_uint32  wal_connect_new_sta_proc_ap(frw_event_mem_stru *pst_event_mem)
{
    ...
    if (OAL_SUCC != ul_ret)
    {
        OAM_WARNING_LOG1(pst_event->st_event_hdr.uc_vap_id, OAM_SF_ASSOC, "{wal_connect_new_sta_proc_ap::oal_cfg80211_new_sta fail[%d]!}\r\n", ul_ret);
        return ul_ret;
    }
#endif
...
#else
    l_ret = oal_cfg80211_del_sta(pst_net_device, auc_disconn_user_addr, GFP_ATOMIC);
    if (OAL_SUCC != l_ret)
    {
        OAM_WARNING_LOG1(pst_event->st_event_hdr.uc_vap_id, OAM_SF_ASSOC, "{wal_disconnect_sta_proc_ap::oal_cfg80211_del_sta return fail[%d]!}\r\n", l_ret);
        return OAL_FAIL;
    }
#endif
...
oal_uint32  wal_send_mgmt_to_host(frw_event_mem_stru *pst_event_mem)
{
    ...
    ***********************************************************************************************/
    ...
    {
        OAM_WARNING_LOG0(pst_event->st_event_hdr.uc_vap_id, OAM_SF_ANY, "{wal_send_mgmt_to_host::auth req!}\r\n");
