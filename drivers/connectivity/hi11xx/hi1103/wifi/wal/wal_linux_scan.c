                                  ...
                                  oal_cfg80211_scan_request_stru        *pst_request)
{
    ...
    if (OAL_SUCC != ul_ret)
    {
        OAM_ERROR_LOG0(0, OAM_SF_CFG, "{wal_scan_work_func:: exit wow fail!}\r\n");
    }
#endif
                                         ...
                                         oal_bool_enum          en_is_aborted)
{
    ...
    {
        OAM_WARNING_LOG1(0, OAM_SF_SCAN, "{wal_force_scan_complete:: mac_vap of net_dev is deleted!iftype:[%d]}",pst_net_dev->ieee80211_ptr->iftype);
        return OAL_SUCC;
    }
