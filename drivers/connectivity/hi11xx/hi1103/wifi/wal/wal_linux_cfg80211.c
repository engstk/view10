                                                          ...
                                                          oal_net_device_stru *pst_netdev)
{
    ...
    OAM_WARNING_LOG3(uc_vap_id, OAM_SF_ANY, "{wal_cfg80211_set_channel_info::l_bandwidth = %d, l_center_freq1 = %d, l_channel = %d.}",
    ...
    {
        en_bandwidth = mac_get_bandwith_from_center_freq_seg0(uc_vht_width, (oal_uint8)l_channel, (oal_uint8)l_channel_center_freq);
    }
