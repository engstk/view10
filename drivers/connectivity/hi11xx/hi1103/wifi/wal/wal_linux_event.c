...
oal_uint32  wal_cfg80211_start_scan(oal_net_device_stru *pst_net_dev, mac_cfg80211_scan_param_stru *pst_scan_param)
{
    ...
    /* 统一在 wal_cfg80211_start_req 外层释放栈内存，避免异常分支的重复释放 */
...
oal_int32  wal_cfg80211_start_connect(oal_net_device_stru *pst_net_dev, mac_conn_param_stru *pst_mac_conn_param)
{
...
{
    return wal_cfg80211_start_req(pst_net_dev, pst_okc_ie, OAL_SIZEOF(oal_app_ie_stru), WLAN_CFGID_SET_VENDOR_IE, OAL_TRUE);
}

oal_int32 wal_cfg80211_set_hiden_whitelist(oal_net_device_stru *pst_net_dev, oal_hilink_white_node_stru *pst_white_lst)
{
    return wal_cfg80211_start_req(pst_net_dev, pst_white_lst, OAL_SIZEOF(oal_hilink_white_node_stru), WLAN_CFGID_SET_WHITE_LIST_SSIDHIDEN, OAL_TRUE);
}

oal_int32 wal_cfg80211_start_fbt_scan(oal_net_device_stru *pst_net_dev, oal_hilink_scan_params *pst_mac_cfg_fbt_scan_params)
{
    return wal_cfg80211_start_req(pst_net_dev, pst_mac_cfg_fbt_scan_params, OAL_SIZEOF(oal_hilink_scan_params), WLAN_CFGID_FBT_START_SCAN, OAL_FALSE);
}

oal_int32 wal_cfg80211_set_mgmt_frame_filter(oal_net_device_stru *pst_net_dev, oal_uint32 *pul_mgmt_frame_filter)
{
    return wal_cfg80211_start_req(pst_net_dev, pul_mgmt_frame_filter, OAL_SIZEOF(oal_uint32), WLAN_CFGID_SET_MGMT_FRAME_FILTERS, OAL_TRUE);
}

oal_int32 wal_cfg80211_set_sensing_bssid(oal_net_device_stru *pst_net_dev, oal_void *pst_sensing_bssid)
{
    return wal_cfg80211_start_req(pst_net_dev, pst_sensing_bssid, OAL_SIZEOF(dmac_sensing_bssid_cfg_stru), WLAN_CFGID_SET_SENSING_BSSID, OAL_TRUE);
}
...
{
    return (oal_uint32)wal_cfg80211_start_req(pst_net_dev, puc_param, OAL_SIZEOF(oal_uint8), WLAN_CFGID_STA_SCAN_CONNECT, OAL_TRUE);
}
#endif
