...
#define DY_CALI_PARAMS_LEN              (90)   /* 动态校准定制项最大长度 */
#define DY_2G_CALI_PARAMS_NUM           (4)    /* 动态校准参数个数,2.4g */
#define DY_CALI_PARAMS_NUM              (9)    /* 动态校准参数个数,2.4g 4个(ofdm 20/40 11b cw),5g 5个band */
...
/* 开机校准MASK */
#define HI1103_CALI_FIST_POWER_ON_MASK      0x04
...
typedef enum
{
    ...
    /* 2G RF前端 */
    WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_2G_BAND_START,    //33
    WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_2G_BAND1_MULT4 = WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_2G_BAND_START,
    WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_2G_BAND2_MULT4,
    WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_2G_BAND3_MULT4,
    WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_2G_BAND_END = WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_2G_BAND3_MULT4,
    /* 5G RF前端 */
    WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_5G_BAND_START,     //37
    WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_5G_BAND1_MULT4 = WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_5G_BAND_START,
    ...
    WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_5G_BAND_END = WLAN_CFG_INIT_RF_LINE_TXRX_GAIN_DB_5G_BAND7_MULT4,
...
typedef struct
{
    ...
    /* FCC边带功率定制项 */
    oal_uint8 auc_5g_fcc_txpwr_limit_params[MAC_NUM_5G_BAND][CUS_NUM_5G_BW];
