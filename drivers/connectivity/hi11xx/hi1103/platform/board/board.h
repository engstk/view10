...
extern int ssi_save_device_regs(void);
extern int ssi_force_reset_aon(void);
extern int ssi_save_device_keyinfo(void);
#else
static inline int ssi_save_device_regs(void)
{
    /*don't support gpio-ssi*/
    return 0;
}

static inline int ssi_save_device_keyinfo(void)
{
     /*don't support gpio-ssi*/
    return 0;
}
...
extern void board_power_reset(uint32 ul_subsystem);
