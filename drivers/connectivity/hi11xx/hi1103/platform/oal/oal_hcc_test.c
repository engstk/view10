...
ssize_t hcc_test_print_thoughput(char*buf, oal_uint32 buf_len)
{
    ...
    ret +=  snprintf(buf + ret,  hcc_test_get_buf_remain_len(buf_len, ret), "PayloadSend %llu bytes, SDIOActualSend  %llu bytes\n",
                                                            g_hcc_test_event->test_data.total_sent_bytes,
                                                            g_hcc_test_event->test_data.trans_info.total_h2d_trans_bytes);
    ret +=  snprintf(buf + ret,  hcc_test_get_buf_remain_len(buf_len, ret), "PayloadRcvd %llu bytes, SDIOActualRecv  %llu bytes\n",
