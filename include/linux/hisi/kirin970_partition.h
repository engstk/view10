...
static const struct partition partition_table_ufs[] =
{
  ...
  #ifdef CONFIG_MARKET_INTERNAL
  {PART_SYSTEM_A,         3428*1024, 4752*1024,     UFS_PART_3},/* system          3552M  p59*/
  #ifdef CONFIG_FACTORY_MODE
  {PART_RESERVED5,        8180*1024, 128*1024,       UFS_PART_3},/* reserved5       128M  p60*/
  {PART_HIBENCH_DATA,   8308*1024, 512*1024,       UFS_PART_3},/* hibench_data      512M  p61*/
  {PART_USERDATA,         8820*1024, (4UL)*1024*1024,UFS_PART_3},/* userdata       4G     p62*/
  #else
  {PART_USERDATA,         8180*1024, (4UL)*1024*1024,UFS_PART_3},/* userdata       4G     p60*/
  #endif
  #else
  {PART_SYSTEM_A,         3428*1024, 5632*1024,     UFS_PART_3},/* system          4688M  p59*/
  #ifdef CONFIG_FACTORY_MODE
  {PART_RESERVED5,        9060*1024, 128*1024,       UFS_PART_3},/* reserved5     128M    p60*/
  {PART_HIBENCH_DATA,   9188*1024, 512*1024,       UFS_PART_3},/* hibench_data    512M    p61*/
  {PART_USERDATA,         9700*1024, (4UL)*1024*1024,UFS_PART_3},/* userdata       4G     p62*/
  #else
  {PART_USERDATA,         9060*1024, (4UL)*1024*1024,UFS_PART_3},/* userdata       4G     p60*/
  #endif
  #endif
  #else
